...
function buyPiePerClick() {
  if (gameData.pie >= gameData.piePerClickCost) {
    ...
    document.getElementById("pieCooked").innerHTML = gameData.pie + " Pies Cooked";
    document.getElementById("perClickUpgrade").innerHTML = "Upgrade Oven (Currently Level " + format(gameData.piePerClick, 'scientific') + ") Cost: " + gameData.piePerClickCost + " Pies";
  }
}
